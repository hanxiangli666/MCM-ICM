...
# # Set font to Arial or Helvetica (standard for scientific journals)
...
# plt.rcParams['axes.grid'] = False     # Minimalist style usually removes default grid
...
# # --- 2. Visualization Functions (Nature Style) ---
...
#     # Create distinct groups for coloring
#     df['Status'] = 'Veteran'
...
#         hue='Status',
#         style='Status',
#         palette=[NATURE_PALETTE[0], NATURE_PALETTE[3]], # Red and Blue
#         s=80, 
#         alpha=0.8,
#         ax=ax1,
#         edgecolor='w',
...
#             ax1.text(
#                 player_data['salary_2025'].values[0] + 5000, 
#                 player_data['per_norm'].values[0], 
#                 name, 
#                 fontsize=8, 
#                 fontweight='bold',
#                 color='#333333'
...
#         y=df['injury_prob'], 
#         ax=ax2, 
#         scatter_kws={'alpha':0.4, 'color': NATURE_PALETTE[2], 's': 50},
...
#     # 3. Fame vs Salary (Hexbin for density or Scatter)
...
#     ax4.set_yticks([]) # Remove y ticks for KDE as magnitude is arbitrary

#     plt.tight_layout()
#     plt.savefig('Figure_1_Data_Exploration.pdf', bbox_inches='tight') # PDF for vector graphics
#     plt.savefig('Figure_1_Data_Exploration.png', dpi=300)
#     print("Pre-modeling visualization saved.")
...
#     # 2. Risk Distribution (Histogram + KDE)
...
#     # Add vertical lines for Expected and CVaR
...
#     # 3. Roster Allocation (Bar Chart - Horizontal)
#     ax3 = fig.add_subplot(gs[1, 0])
...
#     # Plot Stacked Bar for Cap Space
#     y_pos = [0]
#     left = 0
...
#     # 4. Comparative Metrics (Radar or Grouped Bar)
#     ax4 = fig.add_subplot(gs[1, 1:])
...
#     print("Post-modeling visualization saved.")
